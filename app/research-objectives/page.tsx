        ...
        <div className="py-20">
          ...
          <div className="space-y-8">
            <p className="w-full text-[14px] leading-7 text-black/70 mb-6">
              The primary objective of this research is to design and implement a Smart Observability Middleware that enhances the monitoring and reliability of microservice-based systems <a href="#ref-1" className="text-blue-600 hover:underline">[1]</a>. This solution is based on four autonomous agents, each addressing a unique aspect of observability challenges faced by modern distributed systems.
            </p>
            ...
            <p className="w-full text-[14px] leading-7 text-black/70 mb-6">
              The objective of the Metric & Signal Discovery Agent (MSDA) is to automate the identification and collection of essential telemetry signals across the microservices landscape <a href="#ref-1" className="text-blue-600 hover:underline">[1]</a>. This agent will dynamically discover and configure KPIs (Key Performance Indicators) by analyzing both application source code and runtime behavior. The goal is to ensure that no critical metrics are missed, even as services and APIs evolve. The MSDA will also include a route-intent classification module, which maps API routes to semantic categories, ensuring that each API route’s operational purpose is captured and monitored in real-time <a href="#ref-1" className="text-blue-600 hover:underline">[1]</a>.
            </p>
            ...
            <p className="w-full text-[14px] leading-7 text-black/70 mb-6">
              The Log Structuring & Enrichment Agent (LSEA) aims to transform unstructured logs into meaningful, structured data streams <a href="#ref-3" className="text-blue-600 hover:underline">[3]</a>. This agent will employ machine learning techniques, such as semantic log classification <a href="#ref-2" className="text-blue-600 hover:underline">[2]</a> and privacy-preserving data redaction, to ensure logs are both readable and compliant with data protection regulations (e.g., GDPR). The goal is to enhance log usability by providing contextual metadata (e.g., trace IDs, session information) that will enable efficient cross-service debugging and incident analysis <a href="#ref-4" className="text-blue-600 hover:underline">[4]</a>.
            </p>
            ...
            <p className="w-full text-[14px] leading-7 text-black/70 mb-6">
              The Anomaly Detection & Insight Agent (ADIIA) is designed to provide a more context-rich approach to anomaly detection by correlating data across multiple telemetry streams, including logs, metrics, and traces <a href="#ref-4" className="text-blue-600 hover:underline">[4]</a><a href="#ref-5" className="text-blue-600 hover:underline">[5]</a>. Unlike traditional models that treat each anomaly independently, ADIIA will integrate information from various sources to generate a cohesive incident story that explains the root cause and cascading effects of system failures <a href="#ref-5" className="text-blue-600 hover:underline">[5]</a>. The agent will employ machine learning techniques, such as Random Forest and Isolation Forest, to identify patterns and provide actionable insights to operators <a href="#ref-2" className="text-blue-600 hover:underline">[2]</a>, thus improving the speed and accuracy of incident resolution.
            </p>
            ...
            <p className="w-full text-[14px] leading-7 text-black/70 mb-6">
              The final objective is to evaluate the performance of the integrated middleware in experimental environments <a href="#ref-1" className="text-blue-600 hover:underline">[1]</a>. This includes measuring improvements in false positive reduction, anomaly detection accuracy, log processing latency, and the reduction in mean time to detection (MTTD) and resolution (MTTR). Through these evaluations, the middleware’s impact on overall system reliability and performance will be assessed, providing insights into its effectiveness and scalability across different workloads.
            </p>
